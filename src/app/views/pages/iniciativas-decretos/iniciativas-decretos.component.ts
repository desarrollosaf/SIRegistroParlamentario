...
export class IniciativasDecretosComponent implements OnInit, OnDestroy {
  ...
  editCatalogos: { proponentes: any[]; diputados: any[]; partidos: any[]; comisiones: any[]; municipios: any[]; legislaturas: any[]; secretarias: any[]; catfundep: Record<string, any[]>; mesaDirectiva: any | null; jucopo: any | null; dipPermanente: any[] } = {
    proponentes: [], diputados: [], partidos: [], comisiones: [], municipios: [], legislaturas: [], secretarias: [], catfundep: {}, mesaDirectiva: null, jucopo: null, dipPermanente: []
  };
  ...
  abrirModalEditar(iniciativa: Iniciativa): void {
    ...
    this.editCatalogos = { proponentes: [], diputados: [], partidos: [], comisiones: [], municipios: [], legislaturas: [], secretarias: [], catfundep: {}, mesaDirectiva: null, jucopo: null, dipPermanente: [] };
    this.cdr.detectChanges();
    ...
    this._eventoService.getEdicionIniciativa(iniciativa.id)
      ...
      .subscribe({
        next: (data: any) => {
          this.editCatalogos = data.catalogos ?? { proponentes: [], diputados: [], partidos: [], comisiones: [], municipios: [], legislaturas: [], secretarias: [], catfundep: {}, mesaDirectiva: null, jucopo: null, dipPermanente: [] };
  ...
  getEntidadesPorTipo(tipoNombre: string, _proponenteId?: number | null): any[] {
    switch (tipoNombre) {
      ...
      case 'Diputación Permanente':    return this.editCatalogos.dipPermanente ?? [];
      case 'Ayuntamientos':
      case 'Municipios':
