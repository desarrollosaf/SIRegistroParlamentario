...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log('expedientes_estudio_puntos borradas:', yield expedientes_estudio_puntos_1.default.destroy({ where: {} }));
        console.log('expedientes borrados:', yield expediente_1.default.destroy({ where: {} }));
