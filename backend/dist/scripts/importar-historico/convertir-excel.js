...
const DESTINO_CSV = path_1.default.resolve(__dirname, '../../data/historico-iniciativas.csv');
...
function esNotaNoComision(token) {
 ...
 */
function limpiarComisiones(valor) {
    ...
    for (const t of tokens) {
        ...
        if (t.trim().toLowerCase() === 'dispensa')
            continue;
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield workbook.xlsx.readFile(origen);
        ...
        hoja.eachRow((row, rowNumber) => {
            ...
            salida.push([
                ...
                normalizarFecha(get('Fecha de aprobación')),
                get('Estado'),
        ...
        fs_1.default.mkdirSync(path_1.default.dirname(DESTINO_CSV), { recursive: true });
        fs_1.default.writeFileSync(DESTINO_CSV, salida.join('\n') + '\n', 'utf8');
