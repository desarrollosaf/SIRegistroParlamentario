...
router.get("/api/eventos/asistenciaevento/:id", getAsistenciaEvento );
...
router.get("/api/eventos/eliminarinter/:id",eliminarinter );
...
router.post("/api/eventos/savevideopunto/:id", guardarVideoPunto );
